...
class MyStarProfileview extends StatefulWidget {
  final String usrName;

  const MyStarProfileview({super.key, required this.usrName});

  @override
  State<MyStarProfileview> createState() => _MyStarProfileviewState();
}

class _MyStarProfileviewState extends State<MyStarProfileview>
