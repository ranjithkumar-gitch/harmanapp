...
class StargazerSharukhProfile extends StatefulWidget {
  final String usrName;

  const StargazerSharukhProfile({super.key, required this.usrName});

  @override
  State<StargazerSharukhProfile> createState() =>
      _StargazerSharukhProfileState();
}

class _StargazerSharukhProfileState extends State<StargazerSharukhProfile>
