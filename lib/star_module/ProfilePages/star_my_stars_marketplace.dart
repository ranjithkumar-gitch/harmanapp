...
class StarMycreatorsmarketplace extends StatefulWidget {
  const StarMycreatorsmarketplace({super.key});

  @override
  State<StarMycreatorsmarketplace> createState() =>
      _StarMycreatorsmarketplaceState();
}

class _StarMycreatorsmarketplaceState extends State<StarMycreatorsmarketplace> {
  String searchText = "";
